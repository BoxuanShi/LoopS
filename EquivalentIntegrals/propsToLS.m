...
propsToLS0[expr_, opt : OptionsPattern[]] /; OptRestrict[opt] := Module[{loopmoms, rules, tpx1, tpx2, tpx3, tpx4, tpx5, tpx6, tpPos, i, j, x, lamb},
  ...
  Switch[Exponent[tpx1, lamb],
    ...
    tpx3 = (Diagonal[tpx2]*loopmoms) . tpx2[[tpPos]] /. lamb -> 1 // Together // Expand(*l1+l2-lxxx...*);
    tpx4 = 1/2*Coefficient[tpx1, loopmoms[[tpPos]]] /. Thread[loopmoms -> 0] /. lamb -> 1 // Together // Expand(*external momenta...*);
    tpx5 = (expr - (tpx3 + tpx4)^2 // TogetherExpand) /. rules;
