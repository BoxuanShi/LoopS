...
Off statistics;
L F2=ext(q1,q2)*loop(p1)*p1(mu1)*p1(mu2)*p1(mu3)*p1(mu4);
#call opiter
.sort
#call symmetrise
.sort
...
#write </Users/balth/Downloads/LoopS-Mine/packages/LoopS/Examples/LoopSFile/tempopiter/pvreduceout10.m> "%e",F2;
.end
