...
AMFlowInfo["Family"]=AMFfamilyNLO3;
AMFlowInfo["Loop"]={l1};
AMFlowInfo["Leg"]={p, pp};
...
target={j[AMFfamilyNLO3, 0, 1, 1]};
goal=20;
epsorder=4;
res=SolveIntegrals[target,goal,epsorder];
res>>"/Users/balth/Downloads/LoopS-Mine/packages/LoopS/Examples/LoopSFile/Processes/PionEMFF/AMFlow/AMFfamilyNLO3";
