...
Off statistics;
L F2=ext(q1,q2)*loop(p1,p2)*p1(mu1)*p1(mu2)*p1(mu3)*p2(mu4);
#call opiter
.sort
#call symmetrise
.sort
...
#write </Users/balth/Library/Mathematica/Applications/LoopS/Examples/Notebook/LoopSFile/tempopiter/pvreduceout2.m> "%e",F2;
.end
