...
namespace CoCoA
{
  ...
  void program()
  {
    ...
    long n = len(v);  // number of entries in v
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-c++-vector1.C,v 1.1 2021/09/16 11:50:34 bigatti Exp $
