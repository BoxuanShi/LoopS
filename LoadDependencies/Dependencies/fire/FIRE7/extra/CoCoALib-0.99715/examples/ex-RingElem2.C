...
namespace CoCoA
{
  ...
  void TestRing(ring R, RingElem a, const RingElem& b)
  {
    RingElem one(R, 1);
  ...
  void program()
  {
    ...
    RingElem g = RingElem(P, "4*y - 3*y^7 + x^7");
    cout << "----------------------------------------" << endl;
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-RingElem2.C,v 1.1 2021/09/13 13:54:10 abbott Exp $
