...
namespace CoCoA
{
  ...
  void program()
  {
    ...
    // ----------------------------------------------------
    // Translating CoCoA-5 functions APPEND, FIRST and LAST
    // ----------------------------------------------------
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-c++-vector2.C,v 1.4 2021/09/16 11:40:25 bigatti Exp $
