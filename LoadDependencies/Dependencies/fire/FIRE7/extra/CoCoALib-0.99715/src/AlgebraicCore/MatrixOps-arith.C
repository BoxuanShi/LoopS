  ...
  matrix operator*(ConstMatrixView Mleft, ConstMatrixView Mright)
  {
    ...
    if (Rleft != Rright)
    {
      ...
      if (codomain(promote) == Rleft)
        return Mleft * apply(promote,Mright);
      return apply(promote,Mleft) * Mright;
    }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/MatrixOps-arith.C,v 1.4 2021/07/19 11:12:48 abbott Exp $
