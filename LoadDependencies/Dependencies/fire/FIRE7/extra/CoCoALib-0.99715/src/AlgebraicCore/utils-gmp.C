...
///???    if (mpq_sgn(Q) == 0) {*exp = 0; return 0.0; }
    ...
    long log2num = mpz_sizeinbase(mpq_numref(Q),2);
    long log2den = mpz_sizeinbase(mpq_denref(Q),2);
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/utils-gmp.C,v 1.4 2021/09/13 15:34:14 abbott Exp $
// $Log: utils-gmp.C,v $
