...
namespace CoCoA
{
  ...
  namespace SugarTypes
  {
    ...
    public:
      ...
      virtual void myOutput(std::ostream& out) const;
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/SugarDegree.C,v 1.27 2020/06/17 15:49:28 abbott Exp $
// $Log: SugarDegree.C,v $
