...
namespace CoCoA
{
  ...
  public:  // functions which every ring must implement
    ...
    virtual long myNumIndets() const {return myNumIndetsValue;}
    ...
    virtual const PPMonoid& myPPM() const {return myPPMValue;}
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingDistrMPolyInlFpPP.C,v 1.50 2020/06/17 15:49:26 abbott Exp $
