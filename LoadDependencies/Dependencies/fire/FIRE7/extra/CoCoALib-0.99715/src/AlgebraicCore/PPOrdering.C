...
namespace CoCoA
{
  ...
  namespace PPOrd
  {
    ...
    private:
      ...
      XelImpl(const LexImpl&);            ///< NEVER DEFINED -- copy ctor disabled
      XelImpl& operator=(const LexImpl&); ///< NEVER DEFINED -- assignment disabled
    public:
      virtual void myOutputSelf(std::ostream& out) const;
      virtual void myOutputSelf(OpenMathOutput& OMOut) const;
      virtual const ConstMatrixView& myOrdMat() const;
  ...
  namespace PPOrd
  {
    ...
    void XelImpl::myOutputSelf(OpenMathOutput& OMOut) const
    {
      OMOut->mySendApplyStart();
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/PPOrdering.C,v 1.35 2021/02/22 21:09:25 abbott Exp $
// $Log: PPOrdering.C,v $
