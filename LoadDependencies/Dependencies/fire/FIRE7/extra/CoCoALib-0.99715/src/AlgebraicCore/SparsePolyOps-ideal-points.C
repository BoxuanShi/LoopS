...
//   return -1;
  ...
  std::vector<RingElem> BM_modp(const SparsePolyRing& P, const ConstMatrixView& pts)
  {
    ...
    if (modp == nullptr) return std::vector<RingElem>(); // empty list means error
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/SparsePolyOps-ideal-points.C,v 1.3 2020/06/17 15:49:28 abbott Exp $
