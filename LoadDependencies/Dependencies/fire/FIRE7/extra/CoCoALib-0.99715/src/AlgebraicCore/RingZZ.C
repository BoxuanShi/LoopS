//   Copyright (c)  2005-2011,2014  John Abbott and Anna M. Bigatti
...
namespace CoCoA
{
  ...
  public:
    ...
    virtual RingElem mySymbolValue(const symbol& /*sym*/) const {CoCoA_THROW_ERROR("This ring has no symbols", "RingZZImpl::mySymbolValue"); return myZero();}
...
//???    virtual void swap(ideal& other);
    ...
    protected:
      virtual void myTestIsMaximal() const;
      virtual void myTestIsPrimary() const;
      virtual void myTestIsPrime() const;
      virtual void myTestIsRadical() const;
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingZZ.C,v 1.37 2021/01/07 15:16:53 abbott Exp $
// $Log: RingZZ.C,v $
