...
//???    if (v.empty()) CoCoA_THROW_ERROR(ERR::Empty, "MatByCols ctor");
  ...
  namespace // anonymous
  {
    ...
    public:
      ...
      virtual RingElemRawPtr myRawEntry(long, long) { CoCoA_THROW_ERROR(ERR::ConstMatEntry, "myRawEntry"); RingElem JUNK;return raw(JUNK); /*just to keep compiler quiet*/ }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/MatrixView.C,v 1.19 2021/01/07 15:16:51 abbott Exp $
// $Log: MatrixView.C,v $
