//   Copyright (c)  2001-2011,2014  John Abbott and Anna M. Bigatti
...
namespace CoCoA
{
  ...
  public:
    ...
    virtual void myOutputSelfShort(std::ostream& out) const;                            // out << R
...
// RCS header/log
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingFp.C,v 1.56 2021/03/04 21:03:45 abbott Exp $
// $Log: RingFp.C,v $
