...
namespace CoCoA
{
  ...
  public:
    ...
    virtual bool myAppendVec(const std::vector<RingElem>& v);
    virtual const std::vector<RingElem>& myLinReln() const { return myLinRelnValue; }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/LinDepMill.C,v 1.5 2020/06/17 15:49:23 abbott Exp $
// $Log: LinDepMill.C,v $
