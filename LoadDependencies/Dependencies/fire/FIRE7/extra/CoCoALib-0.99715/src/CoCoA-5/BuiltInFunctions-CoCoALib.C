...
DECLARE_STD_BUILTIN_FUNCTION(syz, 1) {
  ...
  switch (which) {
  case 1: CoCoA_THROW_ERROR(ERR::NYI, "minimal syzigies");
    return Value::from(NewFreeModule(RingZZ(),1));
  case 2: CoCoA_THROW_ERROR(ERR::NYI, "minimal syzigies");
    return Value::from(NewFreeModule(RingZZ(),1));
  case 3: {
//     if ()
//     {
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/CoCoA-5/BuiltInFunctions-CoCoALib.C,v 1.85 2021/07/30 15:19:47 bigatti Exp $
