...
FindnumRules[basis_List, process_String : "CurrentProcess"] := FindnumRules[basis, ToExpression[process]]
FindnumRules[basis_List, process_Association] := FindnumRules[basis, process["loopmoms"], process["kinematics"], process["moms"]]
