(-15*s12^4*s15^4*s45^2 + (-14*s12^4*s15^3 + 61*s12^3*s15^4)*s45^3 + 
    ...
    s23*((-24*s12^5*s15^2 + 4*s12^4*s15^3 - 92*s12^3*s15^4)*s45^2 + 
      ...
      s34*((88*s12^5*s15^2 + 116*s12^4*s15^3 - 92*s12^3*s15^4)*s45 + 
        ...
        (28*s12^2 - 440*s12*s15 - 512*s15^2)*s45^6 + (-12*s12 + 96*s15)*
         s45^7))))/(8*(1 + 4*eps)*s12*s23*(s12 + s15 - s34)*
  (-s15 + s23 + s34)*(s12 - s45)*(s12 + s23 - s45)*(-s15 + s23 - s45)*
  (s12 - s34 - s45)*s45^2*(s34 + s45))
